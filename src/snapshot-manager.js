...
import { determineSnapshotPaths, cleanFile, readSnapshotFile, writeSnapshotFile, tryRead } from "./utils.js";
...
export function load({
  ...
  try {
    ...
    if (!updating) {
      snapshotError = new Error(`Invalid snapshot file, ${paths.snapPath}`, { cause: error });
    }
  }
